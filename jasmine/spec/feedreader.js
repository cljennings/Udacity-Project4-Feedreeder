...
$(function() {
         ...
         */
         it('have a defined url', function () {
           allFeeds.forEach(function (element) {
             const arrayItem = element.url;
             expect(arrayItem).toBeDefined();
             expect(arrayItem).not.toBe('');
           })
          });
    ...
    describe('The menu', function() {
         ...
         */
         it('is hidden', function() {
           const classInfo = document.querySelector('body').className;
           expect(classInfo).toBe('menu-hidden');
         });
   ...
   describe('Initial Entries', function() {
         ...
         */
         ...
         it('is called and has an entry',function(done){
...
//   describe('New Feed Selection', function() {
         ...
         * Remember, loadFeed() is asynchronous.
         ...
         beforeEach(function(done) {
           loadFeed(0, done);
           firstEntry = document.querySelector('.feed');
           loadFeed(1, done);
           secondEntry = document.querySelector('.feed');
         });
